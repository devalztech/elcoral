  ...
  return (
    ...
    >
      ...
      <style>{`
        ...
        @media (hover: hover) and (pointer: fine) { .photo-circle:hover { border-color: var(--accent-ink); color: var(--accent-ink); } }
        ...
        @media (hover: hover) and (pointer: fine) { .photo-remove:hover { color: var(--danger); } }
