    ...
    <div className="cm">
          ...
          <span className="cm-promo-art" aria-hidden="true">
            <svg viewBox="0 0 160 120" width="132" height="99" fill="none">
              ...
              {[[62, 30, 15], [30, 44, 11], [96, 42, 12], [76, 74, 10], [44, 90, 11], [122, 52, 8], [118, 84, 8], [138, 34, 6]].map(([x, y, r], i) => (
                <g key={i}>
                  <circle cx={x} cy={y} r={r} fill="var(--panel)" stroke="var(--lemon)" strokeWidth="1.4" />
      ...
      <style>{`
        ...
        .cm-promo {
          ...
          background: linear-gradient(120deg, var(--panel-raised) 0%, var(--panel) 60%, var(--panel-raised) 100%);
